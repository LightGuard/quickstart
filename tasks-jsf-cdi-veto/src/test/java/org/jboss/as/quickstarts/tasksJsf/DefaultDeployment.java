...
import org.jboss.as.quickstarts.tasksJsf.extension.JpaVetoExtension;
...
public class DefaultDeployment {
    ...
    public DefaultDeployment(String archiveName) {
        webArchive = ShrinkWrap.create(WebArchive.class, archiveName).addAsWebInfResource(
                new File(WEBAPP_SRC, "WEB-INF/beans.xml"));
    }
    ...
    public DefaultDeployment withCdiExtension() {
        webArchive = webArchive.addClass(JpaVetoExtension.class).addAsServiceProvider(Extension.class, JpaVetoExtension.class);
        return this;
    }
